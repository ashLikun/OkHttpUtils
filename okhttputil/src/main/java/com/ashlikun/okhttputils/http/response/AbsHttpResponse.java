 ...
 */
abstract class AbsHttpResponse implements IHttpResponse {
    /**
     * 原始数据
     */
    ...
    public AbsHttpResponse() {
    }

    public AbsHttpResponse(String json) {
        this.json = json;
    }
    ...
    public Object getKeyToObject(String... key) {
     ...
     */
    public <T> T getValueBase(String... key) {
        if (key == null || key.length == 0) {
            return null;
        }
    ...
    public String getStringValueDefault(String defaultValue, String... key) {
        String res = HttpUtils.toString(getValueBase(key));
        return res == null ? defaultValue : res;
    }
